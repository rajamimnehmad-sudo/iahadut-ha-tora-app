...
(() => {
  ...
  const categoryIcon = (key) => {
    const paths = {
      ...
      uruguay: '<defs><clipPath id="uruguayClip"><circle cx="12" cy="12" r="9"/></clipPath></defs><circle cx="12" cy="12" r="9" fill="#fff" stroke="#4f86b3" stroke-width="1.2"/><g clip-path="url(#uruguayClip)"><rect x="3" y="3" width="18" height="18" fill="#fff"/><path d="M3 5h18v2H3zM3 9h18v2H3zM3 13h18v2H3zM3 17h18v2H3z" fill="#62a5d2"/><rect x="3" y="3" width="8" height="8" fill="#fff"/><circle cx="7" cy="7" r="1.25" fill="#f2bd3d"/><path d="M7 4.9v.9M7 8.2v.9M4.9 7h.9M8.2 7h.9M5.5 5.5l.7.7M8.5 5.5l-.7.7M5.5 8.5l.7-.7M8.5 8.5l-.7-.7" stroke="#c18b24" stroke-width=".55" stroke-linecap="round"/></g>'
    };
  ...
  function infoContentMarkup(content) {
    ...
    const actionIcon = (kind) => {
      if (kind === 'whatsapp') return '<img class="info-action-icon whatsapp-logo" src="assets/whatsapp.svg" alt="">';
